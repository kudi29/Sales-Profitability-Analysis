...
Combined documentation for all three pages of the Power BI report: Executive Overview,  
Discount Analysis, and Product & Category Performance.
...
Give a senior stakeholder the full profitability story in under 10 seconds:  
Is the business growing, is it profitable, where's the risk, and is anything urgent enough to need attention right now?
